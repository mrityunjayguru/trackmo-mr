...
class Utils{
   ...
   Widget topBar({
    ...
    return  GestureDetector(
      ...
      child: Container(
        ...
        ).paddingOnly(top: 12, bottom: 12, left: 6, right: 6),
      ),
    );
  }
  ...
  static void getSnackbar(String title, String message){
    Get.snackbar(title, message, backgroundColor: AppColors.selextedindexcolor, colorText: Colors.black,snackPosition: SnackPosition.BOTTOM);
  }
