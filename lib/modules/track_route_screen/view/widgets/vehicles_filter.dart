        ...
        children: [
          Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.only(topLeft: Radius.circular(AppSizes.radius_24), topRight: Radius.circular(AppSizes.radius_24), bottomRight: Radius.circular(AppSizes.radius_16), bottomLeft: Radius.circular(AppSizes.radius_16)),
                                ...
                                itemBuilder: (BuildContext context, int index) =>
                                    GestureDetector(
                                      ...
                                      onTap: () {
                                        ...
                                        controller.isShowVehicleDetails(index);
                                        controller.devicesByDetails(controller.vehicleList.value
                                            .data?[index].imei ??
                                            '');
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    controller.isExpanded.value = false;
                                                    controller.devicesByDetails(controller
                                                        .vehicleList
                                                        .value
                                                        .data?[index]
                                                        .imei ??
