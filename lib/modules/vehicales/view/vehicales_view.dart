        ...
        child: Column(
          children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => InkWell(
                      onTap: () {
                        ...
                        // After selecting a filter, refresh the list
            ...
            searchApptextfield(
              ...
              onChanged: (query) =>
                  controller.filterVehicles(query), // Enable search filtering
            ),
              ...
              child: Obx(() {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: () {
                        controller.trackRouteController.removeRoute();
                        bottomController.updateIndex(2);
                        controller.trackRouteController
                            .devicesByDetails(vehicle.imei ?? '');
                        controller.trackRouteController
