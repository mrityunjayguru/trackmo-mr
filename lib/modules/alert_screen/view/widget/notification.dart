        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('$date at $time', style: AppTextStyles(context).display14W400.copyWith(color: AppColors.grayLight),).paddingOnly(
                left: 6.7.w,
                top: 1.w,
              ),
            ],
      ...
      return Column(
        children: [
           GestureDetector(
              ...
              onTap: () {
                alertController.isExpanded.value = !alertController.isExpanded.value;
              },
              child: Container(
                height: 4.8.h,
                decoration: BoxDecoration(
                ...
                child: Row(
                  children: [
                    ...
                    Spacer(),
                    SvgPicture.asset(
                      alertController.isExpanded.value ? "assets/images/svg/ic_arrow_up.svg": Assets.images.svg.icArrowDown,
